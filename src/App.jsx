...
import { 
  ...
  ChevronRight, ChevronDown, CornerDownRight, PieChart, TrendingUp, TrendingDown, DollarSign, Activity, Wallet, Percent, Users, ScanSearch, Eye, FileWarning, Globe, Layers, Lock, Server, Users2
} from 'lucide-react';
...
// ============================================================================
// MÓDULO 0.A: PORTA DE ENTRADA (LOGIN SCREEN)
// ============================================================================
                           ...
                           <div key={emp.id} className="p-5 bg-slate-900 border border-slate-700 rounded-2xl flex flex-col justify-between">
                             <div>
                               <div className="flex justify-between items-start mb-2">
                                 <span className="px-2 py-1 bg-emerald-500/10 text-emerald-400 text-[8px] font-black uppercase tracking-widest rounded-md border border-emerald-500/20">{emp.status}</span>
                                 <span className="text-[10px] font-mono text-slate-500">{emp.id.split('-')[0]}</span>
                               </div>
...
export default function App() {
  ...
  // VERIFICAÇÃO DE AUTENTICAÇÃO E PERFIL (O GUARDA-COSTAS)
  useEffect(() => {
