...
import { 
  ...
  Search, LineChart // <- CORREÇÃO: Adicionados os ícones que faltavam para não quebrar a Vercel
} from 'lucide-react';
...
import Layout from '../components/Layout'; // <- ADICIONADO: O nosso esqueleto visual
// ============================================================================
...
export default function Dashboard() {
  ...
  // ============================================================================
  // ADICIONADO: Envolvendo o conteúdo da tela com o <Layout>
  // ============================================================================
  return (
    <Layout>
